...
"""
        ...
        self.assertEqual(symbols.get("Z_POS"), -0.5)
        self.assertEqual(state.axes.get("Z"), -0.5)
...
#        self.assertEqual(result[0]["programExec"].count(7), 2)
        ...
        state = ctrl.get_nc_state(1)
        self.assertEqual(state.axes.get("Z"), 3.5)
        self.assertEqual(state.axes.get("X"), 8.5)
